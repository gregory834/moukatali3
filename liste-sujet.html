    ...
    <section>
        <div class="container pt-4">
            ...
            <div class="sujet bg-light p-3 mb-3 d-flex flex-column flex-md-row align-items-md-center">
                <div class="image mb-2 mb-md-0 mr-md-2 d-lg-none"><img src="images/image-mobile.jpg"
                        alt="Image du sujet"></div>
        ...
        <div class="container py-4">
            ...
            <div class="moukatage p-3 bg-light text-dark mb-3">
                ...
                <div class="d-md-flex justify-content-md-between">
                    <!-- LIKE DISLIKE -->
                    <div
                        class="like-dislike d-flex justify-content-end justify-content-md-start align-items-md-end mb-4 mb-md-0 order-md-1">
