                ...
                <?php foreach ($topics as $key => $topic) : ?>
                  <div class="user">
                    <tr>
                      ...
                      <?php if ($_SESSION['user']['role'] == "admin") : ?>
                        <td class="align-middle">
                          <?php if ($topic['published'] == 0) : ?>
                            <a href="form-subject-editer.php?unpublish=<?= $topic['id'] ?>" role="button">
                          ...
                          <?php else : ?>
                            <a href="form-subject-editer.php?publish=<?= $topic['id'] ?>" role="button">
                      ...
                      <?php endif; ?>
                      <td class="align-middle">
                        <a class="text-dark" href="form-subject-editer.php?edit-topic=<?= $topic['id'] ?>" role="button">
                      ...
                      <td class="align-middle">
                        <a class="text-dark" href="form-subject-editer.php?delete-topic=<?= $topic['id'] ?>" role="button">
