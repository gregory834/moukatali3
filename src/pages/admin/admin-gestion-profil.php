<div class="text-light">
  ...
  <title>GestionProfil | Moukat A Li</title>
  ...
  <body>
    ...
    <section id="form-admin">
      <div class="container">
        ...
        <h6 class="text-uppercase display-4 text-center py-3 mt-5">Gestion des profils</h6>


        <form method="POST" action="admin-gestion-profil.php" class="m-auto">
          <!-- MESSAGE D ERREUR -->
                ...
                <div class="user">
                  <tr>
                    ...
                    <td class="align-middle">
                      <a class="text-dark" href="admin-gestion-profil.php?edit-admin=<?php echo $ligne_AdminAuthorModerator['id']; ?>" role="button">
                    ...
                    <td class="align-middle">
                      <a class="text-dark" href="admin-gestion-profil.php?delete-admin=<?php echo $ligne_AdminAuthorModerator['id']; ?>" role="button">
