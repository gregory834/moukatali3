                ...
                <div class="user">
                  <tr>
                    ...
                    <td class="align-middle">
                      <a class="text-dark" href="dashboard.php?edit-admin=<?php echo $ligne_AdminAuthorModerator['id']; ?>" role="button">
                    ...
                    <td class="align-middle">
                      <a class="text-dark" href="dashboard.php?delete-admin=<?php echo $ligne_AdminAuthorModerator['id']; ?>" role="button">
