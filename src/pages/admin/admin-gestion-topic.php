  ...
  <body>
    ...
    <section id="form-subject">
      ...
      <h1 class="text-uppercase display-1 text-center py-3 mt-5">administrateur</h1>
        ...
        <form method="post" action="admin-gestion-topic.php" enctype="multipart/form-data">
                    ...
                    <tr>
                      ...
                      <?php if ($user_info['role'] === "admin") : ?>
                        <td class="align-middle">
                          ...
                          <?php else : ?>
                            <a href="admin-gestion-topic.php?publish=<?= $topic['id'] ?>" role="button">
                      ...
                      <?php endif; ?>
                      <td class="align-middle">
                        <a class="text-dark" href="admin-gestion-topic.php?edit-topic=<?= $topic['id'] ?>" role="button">
                      ...
                      <td class="align-middle">
                        <a class="text-dark" href="admin-gestion-topic.php?delete-topic=<?= $topic['id'] ?>" role="button">
