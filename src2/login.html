...
<head>
  ...
  <title>Connexion - Moukat A Li</title>
</head>
...
<body>
  ...
  <section id="form-login" class="h-100">
    ...
    <h5 class="fw-light text-uppercase">connexion</h5>
    <form method="post" action="login.php" class="px-3 text-center">
        <?php include(ROOT_PATH . '/includes/errors.php') ?>
        <!-- PSEUDO -->
        <div class="mb-3 text-start">
          <label for="username" class="form-label">Pseudo</label>
          <input type="text" class="form-control" id="username" name="username" required
            pattern="^[a-zA-Z][a-zA-Z0-9-_\.]{1,20}$" minlength="1" maxlength="30" size="30">
        </div>
        <!-- MOT DE PASSE -->
        <div class="mb-3 text-start">
        ...
        <button type="submit" class="btn btn-primary fw-bold text-uppercase border-0" name="login">se connecter</button>
    </form>
